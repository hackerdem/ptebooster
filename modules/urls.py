...
urlpatterns = [
    ...
    path('listening-write-from-dictation/', DictationListView.as_view(),name='write-from-dictation'),
    ...
    path('speaking-read-aloud/', ReadAloudView.as_view(),name='speaking-read-aloud'),
    path('speaking-retell-lecture/', RetellLectureView.as_view(),name='re-tell-lecture'),
    path('writing-write-essay/',EssayView.as_view(),name='write-essay'),
    path('listening-fill-in-blanks/',FillInBlanksView.as_view(),name='listening-fill-in-blanks'),
    ...
    path('listening-multiple-selection/',MultipleSelectionView.as_view(),name='listening-multiple-selection'),
    path('reading-multiple-selection/',MultipleSelectionReadingView.as_view(),name='reading-multiple-selection'),
